...
export const Header = ({ theme, position }) => {
  return (
    <header className={position ? "absolute w-full z-50 px-4" : ""}>
        ...
        <div className="flex flex-stretch items-center">
          ...
          <div className="w-auto">
            <ul className="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center" id="menu">
              <li className="mx-3 py-6 md:py-0">
                <Link to="/showcase" className={theme === "white" ? "text-black md:text-white hover:underline" : "text-white md:text-black hover:underline"}>
                  Showcase
                </Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
          ...
          <div className="w-auto">
            <ul className="items-center flex">
              ...
              <li className="ml-6">
                <Link className={theme === "white" ? "text-black md:text-white hover:underline" : "text-white md:text-black hover:underline"} to="/cart">
